...
st.image("https://github.com/siddharthswami04/AI_Resume_Maker_and_job_Tracker/blob/main")
st.sidebar.title("Fill Important Details")
st.sidebar.image("https://github.com/siddharthswami04/AI_Resume_Maker_and_job_Tracker/blob/main")
